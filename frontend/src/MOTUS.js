export function setMultiselect(data){    
    var Motus = {};
    (function() {
    var createMultiselect = function(element, data, selectCb, options) {
        ...
        labels.selectedAllText = (options && options.selectedAllText) ? options.selectedAllText : '';
        ...
        clearSelection.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#327FE9" class="bi bi-x" viewBox="0 0 16 16">'+
    ...
    var element = document.getElementById("taskSelection");
